...
--
-- Host: localhost
-- Waktu pembuatan: 02 Feb 2020 pada 02.35
...
CREATE TABLE `ref_city` (
  `city_id` varchar(4) NOT NULL COMMENT 'ID kota',
  `city_province_id` varchar(2) NOT NULL COMMENT 'ID provinsi',
  `city_name` varchar(100) NOT NULL COMMENT 'nama kota'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table kota';

--
-- Dumping data untuk tabel `ref_city`
--

INSERT INTO `ref_city` (`city_id`, `city_province_id`, `city_name`) VALUES
...
--
-- Struktur dari tabel `ref_hacker`
--

CREATE TABLE `ref_hacker` (
  `hacker_id` int(12) NOT NULL,
  `hacker_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `ref_hacker`
--

INSERT INTO `ref_hacker` (`hacker_id`, `hacker_name`) VALUES
(4072, 'Rosa'),
(4807, 'Anjani'),
(26072, 'Frodo'),
(49439, 'Palma'),
...
CREATE TABLE `ref_province` (
  `province_id` varchar(2) NOT NULL COMMENT 'ID provinsi',
  `province_name` varchar(100) NOT NULL COMMENT 'nama provinsi'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table provinsi';

--
-- Dumping data untuk tabel `ref_province`
--
...
CREATE TABLE `ref_subdistrict` (
  `subdistrict_id` varchar(6) NOT NULL COMMENT 'ID kecamatan',
  `subdistrict_city_id` varchar(4) NOT NULL COMMENT 'ID kota',
  `subdistrict_name` varchar(100) NOT NULL COMMENT 'nama kecamatan'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table kecamatan';

--
-- Dumping data untuk tabel `ref_subdistrict`
--

INSERT INTO `ref_subdistrict` (`subdistrict_id`, `subdistrict_city_id`, `subdistrict_name`) VALUES
...
--
-- Struktur dari tabel `ref_submission`
--

CREATE TABLE `ref_submission` (
  `submission_id` int(12) NOT NULL,
  `submission_hacker_id` int(25) NOT NULL,
  `submission_challenge_id` int(12) NOT NULL,
  `submission_score` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `ref_submission`
--

INSERT INTO `ref_submission` (`submission_id`, `submission_hacker_id`, `submission_challenge_id`, `submission_score`) VALUES
(67195, 74843, 63133, 76),
...
--
-- Struktur dari tabel `site_configuration`
--
...
CREATE TABLE `site_configuration` (
  ...
  `configuration_is_required` tinyint(1) UNSIGNED NOT NULL DEFAULT 1,
  `configuration_order_by` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `configuration_is_show` tinyint(1) UNSIGNED NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data konfigurasi situs';

--
-- Dumping data untuk tabel `site_configuration`
--

INSERT INTO `site_configuration` (`configuration_id`, `configuration_name`, `configuration_type`, `configuration_title`, `configuration_value`, `configuration_is_required`, `configuration_order_by`, `configuration_is_show`) VALUES
(1, 'appname', 'text', 'Nama Aplikasi', 'Core Admin', 1, 1, 0),
(2, 'title', 'text', 'Judul Situs', 'Core Admin', 1, 2, 1),
(3, 'keyword', 'textarea', 'Meta Keyword', 'Core Admin', 1, 3, 1),
(4, 'description', 'textarea', 'Meta Description', 'Core Admin', 1, 4, 1),
(5, 'footer', 'text', 'Footer', 'Copyright &copy; 2018 <a href=\"http://coday.id\" target=\"_blank\"><strong>coday.id</strong></a>. All rights reserved.', 1, 5, 1),
(6, 'frontend_themes', 'text', 'Tema Front End', 'coming_soon', 1, 6, 0),
(7, 'backend_themes', 'text', 'Tema Back End', 'gentelella', 1, 7, 0),
(8, 'member_themes', 'text', 'Tema Member', 'default', 1, 8, 0);
...
CREATE TABLE `sys_administrator` (
  ...
  `administrator_administrator_group_id` int(10) UNSIGNED NOT NULL,
  `administrator_username` varchar(50) NOT NULL DEFAULT 'esoftdream',
  `administrator_password` text DEFAULT NULL,
  `administrator_name` varchar(50) DEFAULT NULL,
  `administrator_email` varchar(50) DEFAULT NULL,
  `administrator_mobilephone` varchar(20) NOT NULL DEFAULT '',
  `administrator_image` varchar(255) DEFAULT NULL,
  `administrator_last_login` datetime DEFAULT NULL,
  `administrator_is_active` tinyint(1) UNSIGNED NOT NULL DEFAULT 1,
  `administrator_active_lang` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 = english, 1 = bahasa indonesia'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data administrator';

--
-- Dumping data untuk tabel `sys_administrator`
--

INSERT INTO `sys_administrator` (`administrator_id`, `administrator_administrator_group_id`, `administrator_username`, `administrator_password`, `administrator_name`, `administrator_email`, `administrator_mobilephone`, `administrator_image`, `administrator_last_login`, `administrator_is_active`, `administrator_active_lang`) VALUES
(1, 1, 'superuser', '$2y$10$TiuWJjPEofSs316UC/0./e4Jc6qqX0HpgJetsv3vDXnCnp4Ze2U/O', 'Fadhillah ', 'superuser@admin.com', '098973847085', 'Fadhillah-20191229074055.jpeg', '2020-01-30 19:36:41', 1, 0),
(2, 22, 'wawanz', '$2y$10$XxVazPY9TIYns/On73hcDOR8dOg1B0ECaDPE6Y0Aneq/OMKRLuxRC', 'Setyo', '', '0875676576', NULL, '2018-12-25 07:49:20', 1, 0),
(3, 10, 'ajengw', '$2y$10$8NhEnwOP6pxGY11hW6ZNb.4JyfliP6VRZwDO4rBLzvpuxQ84Zpr/a', 'Ajeng Wardani', '', '08645653543', NULL, '2019-10-24 10:58:34', 1, 0),
(4, 8, 'adminwarehousee', '$2y$10$nGhDj2DT5DRGXf5WPEAs9.ZkhLJHE1PC3kYZ.axhsOlEI6KRMSECi', 'admin warehouse', '', '097899768768', NULL, '2019-02-26 09:53:50', 1, 0),
(6, 12, 'bellasukses', '$2y$10$4ExC0nr1iOonO2WM1Bg.9e6wibkabpy.pO9CLsrdSjwqSxaB2NiF.', 'Bella', '', '08123445678', NULL, '2019-03-15 15:17:38', 1, 0),
(7, 10, 'cobawarehouse', '$2y$10$5yiHgDPuXEutfPQy4NXuIOGERILWY2SzbJMmlx/ILBlYzvvX3JuxK', 'coba warehouse', '', '082761836138', NULL, NULL, 0, 0),
(8, 3, 'admincompany', '$2y$10$bYTROY7dXm9V91ibB5hLNeYSa1WTd9.u/ByYiBVLWhfcvnXTkG5oK', 'Ajeng Wardani', '', '081234567890', 'Ajeng-Wardani-20190401104010.jpg', '2019-10-29 13:54:16', 1, 0),
(9, 10, 'adminwarehouse', '$2y$10$jUeHuJVbVheHSO3ucEA.6ebzROQErqkXm.p./SurvubzurYL/05Oy', 'admin warehouse', '', '081234567890', NULL, '2019-10-29 14:09:24', 1, 0),
(10, 18, 'adminstore', '$2y$10$bTzfYItjJ0n2RbEe6Kim5eRqryAJkY7F/D/BfLZylW2eZm0ZwQdOW', 'Ajeng Wardani Store1', '', '081234567890', NULL, '2019-07-10 09:18:33', 1, 0),
(11, 18, 'barista', '$2y$10$V.luHf4Jvxxqiv3YjzCgjug1K1p6rQQpbRr35fKoh.3Dl1xH6dJLC', 'barista coday resto', '', '081234567890', NULL, NULL, 1, 0),
(12, 23, 'kasircentral', '$2y$10$xnrxxXL14FUTmWAwVA69reMvIAUwb129uunNWnuOfqDQTPt8NaWSi', 'Kasir Central', '', '081234567890', NULL, '2019-08-03 05:07:54', 1, 0),
(15, 26, 'kasirmerchant1', '$2y$10$BU6Bigqt2zrO07/AQrSo.eXTbZz.VY7o42GmHsjKgS9tcBpBPXgxa', 'Kasir Merchant 1', '', '081234567890', NULL, '2019-08-02 16:05:57', 1, 0),
(16, 27, 'kasirmerchant2', '$2y$10$ctiCkz2kNDLk562dLXwI4u8C.hbC6YYYrONubDewVI7jftbIrP9gG', 'Kasir Merchant 2', '', '081234567890', NULL, NULL, 1, 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `sys_administrator_group`
--

CREATE TABLE `sys_administrator_group` (
  `administrator_group_id` int(10) UNSIGNED NOT NULL,
  `administrator_group_company_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `administrator_group_warehouse_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `administrator_group_pos_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `administrator_group_title` varchar(50) DEFAULT NULL,
  `administrator_group_type` enum('superuser','administrator_company','administrator_warehouse','administrator_pos','administrator_cashier') NOT NULL DEFAULT 'administrator_warehouse',
  `administrator_group_is_active` tinyint(1) UNSIGNED NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data grup administrator';

--
-- Dumping data untuk tabel `sys_administrator_group`
--

INSERT INTO `sys_administrator_group` (`administrator_group_id`, `administrator_group_company_id`, `administrator_group_warehouse_id`, `administrator_group_pos_id`, `administrator_group_title`, `administrator_group_type`, `administrator_group_is_active`) VALUES
(1, 0, 0, 0, 'Superuserr', 'superuser', 1),
(3, 3, 0, 0, 'Admin Company', 'administrator_company', 1),
(8, 4, 4, 0, 'admin warehouse', 'administrator_warehouse', 1),
(10, 3, 3, 0, 'Admin Warehouse', 'administrator_warehouse', 1),
(12, 2, 2, 2, 'Owner', 'administrator_company', 1),
(18, 3, 0, 10, 'Admin Store', 'administrator_pos', 1),
(19, 3, 3, 0, 'Barista', 'administrator_warehouse', 1),
(20, 3, 3, 0, 'Kitchen', 'administrator_warehouse', 1),
(21, 3, 0, 10, 'Server', 'administrator_pos', 1),
(23, 12, 0, 13, 'Cahier Central', 'administrator_cashier', 1),
(26, 13, 0, 14, 'Admin Merchant 1', 'administrator_pos', 1),
(27, 14, 0, 15, 'Admin Merchant 2', 'administrator_pos', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `sys_administrator_menu`
--

CREATE TABLE `sys_administrator_menu` (
  `administrator_menu_id` int(10) UNSIGNED NOT NULL,
  `administrator_menu_par_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `administrator_menu_title` varchar(50) NOT NULL,
  `administrator_menu_description` varchar(255) DEFAULT NULL,
  `administrator_menu_link` varchar(255) DEFAULT '#',
  `administrator_menu_action` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'create, update, delete, approve' CHECK (json_valid(`administrator_menu_action`)),
  `administrator_menu_icon` varchar(255) DEFAULT NULL,
  `administrator_menu_class` varchar(255) DEFAULT NULL,
  `administrator_menu_order_by` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `administrator_menu_is_active` tinyint(1) UNSIGNED NOT NULL DEFAULT 1,
  `administrator_menu_type` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Tipe menu. 0 = backoffice, 1 = ecommerce'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data menu administrator';

--
-- Dumping data untuk tabel `sys_administrator_menu`
--

INSERT INTO `sys_administrator_menu` (`administrator_menu_id`, `administrator_menu_par_id`, `administrator_menu_title`, `administrator_menu_description`, `administrator_menu_link`, `administrator_menu_action`, `administrator_menu_icon`, `administrator_menu_class`, `administrator_menu_order_by`, `administrator_menu_is_active`, `administrator_menu_type`) VALUES
(6, 24, 'Warehouse', '', 'master/warehouse/show', '{\"results\": [{\"name\": \"show\", \"title\": \"Show Data\"}, {\"name\": \"add\", \"title\": \"Add\"}, {\"name\": \"update\", \"title\": \"Edit\"}, {\"name\": \"delete\", \"title\": \"Delete\"}, {\"name\": \"export\", \"title\": \"Export\"}]}', NULL, 'fa fa-pie-chart', 2, 1, 0),
(7, 0, 'Administrator', '', '#', '{\"results\": [{\"name\": \"show\", \"title\": \"Lihat Data\"}]}', NULL, 'fa fa-user', 5, 1, 0),
(8, 7, 'Menu', '', 'admin/administrator_menu/show', '{\"results\": [{\"name\": \"show\", \"title\": \"Show Data\"}, {\"name\": \"add\", \"title\": \"Add\"}, {\"name\": \"update\", \"title\": \"Edit\"}, {\"name\": \"delete\", \"title\": \"Delete\"}, {\"name\": \"activate\", \"title\": \"Activate\"}, {\"name\": \"deactivate\", \"title\": \"Deactivate\"}]}', NULL, 'fa fa-th-large', 3, 1, 0),
(9, 7, 'Group', '', 'admin/administrator_group/show', '{\"results\": [{\"name\": \"show\", \"title\": \"Show Data\"}, {\"name\": \"add\", \"title\": \"Add\"}, {\"name\": \"update\", \"title\": \"Edit\"}, {\"name\": \"delete\", \"title\": \"Delete\"}, {\"name\": \"activate\", \"title\": \"Activate\"}, {\"name\": \"deactivate\", \"title\": \"Deactivate\"}]}', NULL, 'fa fa-users', 1, 1, 0),
(10, 7, 'User', '', 'admin/administrator/show', '{\"results\": [{\"name\": \"show\", \"title\": \"Show Data\"}, {\"name\": \"add\", \"title\": \"Add\"}, {\"name\": \"update\", \"title\": \"Edit\"}, {\"name\": \"delete\", \"title\": \"Delete\"}, {\"name\": \"activate\", \"title\": \"Activate\"}, {\"name\": \"deactivate\", \"title\": \"Deactivate\"}, {\"name\": \"update_password\", \"title\": \"Edit Password\"}]}', NULL, 'fa fa-user', 2, 1, 0),
(24, 0, 'Setup', '', '#', '{\"results\": [{\"name\": \"show\", \"title\": \"Show Data\"}]}', NULL, 'fa fa-cogs', 0, 1, 0),
(25, 24, 'Company', '', 'master/company/show', '{\"results\": [{\"name\": \"show\", \"title\": \"Show Data\"}, {\"name\": \"add\", \"title\": \"Add\"}, {\"name\": \"update\", \"title\": \"Edit\"}, {\"name\": \"delete\", \"title\": \"Delete\"}, {\"name\": \"export\", \"title\": \"Export\"}]}', NULL, 'fa fa-building', 1, 1, 0),
(52, 24, 'Store', '', 'master/pos/show', '{\"results\": [{\"name\": \"show\", \"title\": \"Show Data\"}, {\"name\": \"add\", \"title\": \"Add\"}, {\"name\": \"update\", \"title\": \"Edit\"}, {\"name\": \"delete\", \"title\": \"Delete\"}, {\"name\": \"export\", \"title\": \"Export\"}]}', NULL, 'fa fa-desktop', 3, 1, 0),
(111, 0, 'Karyawan', '', 'crud/karyawan/show', '{\"results\":[{\"name\": \"show\",\"title\": \"Show Data\"}]}', NULL, 'fa fa-book', 6, 1, 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `sys_administrator_menu_ref_action`
--

CREATE TABLE `sys_administrator_menu_ref_action` (
  `administrator_menu_ref_action_id` int(10) UNSIGNED NOT NULL,
  `administrator_menu_ref_action_name` varchar(50) NOT NULL,
  `administrator_menu_ref_action_title` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data referensi penamaan action hak akses action menu';

--
-- Dumping data untuk tabel `sys_administrator_menu_ref_action`
--

INSERT INTO `sys_administrator_menu_ref_action` (`administrator_menu_ref_action_id`, `administrator_menu_ref_action_name`, `administrator_menu_ref_action_title`) VALUES
(1, 'add', 'Add'),
(2, 'update', 'Edit'),
(3, 'delete', 'Delete'),
(4, 'export', 'Export'),
...
(7, 'import', 'Import'),
(8, 'download', 'Download'),
(9, 'update_password', 'Edit Password'),
(10, 'approve', 'Approve'),
(11, 'reject', 'Reject'),
(12, 'cancel', 'Cancel'),
(13, 'closed', 'Close'),
...
--
-- Struktur dari tabel `sys_administrator_privilege`
--

CREATE TABLE `sys_administrator_privilege` (
  `administrator_privilege_id` int(10) UNSIGNED NOT NULL,
  `administrator_privilege_administrator_group_id` int(10) UNSIGNED NOT NULL,
  `administrator_privilege_administrator_menu_id` int(10) UNSIGNED NOT NULL,
  `administrator_privilege_action` varchar(255) DEFAULT NULL COMMENT 'create, update, delete, approve'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='data hak akses menu administrator';

--
-- Dumping data untuk tabel `sys_administrator_privilege`
--

INSERT INTO `sys_administrator_privilege` (`administrator_privilege_id`, `administrator_privilege_administrator_group_id`, `administrator_privilege_administrator_menu_id`, `administrator_privilege_action`) VALUES
(102, 8, 19, '{\"results\": [\"show\"]}'),
(103, 8, 35, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(104, 8, 32, '{\"results\": [\"show\"]}'),
(105, 8, 20, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(106, 8, 21, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(107, 8, 28, '{\"results\": [\"show\",\"export\"]}'),
(108, 8, 26, '{\"results\": [\"show\",\"export\",\"closed\"]}'),
(109, 8, 27, '{\"results\": [\"show\",\"closed\"]}'),
(606, 12, 24, '{\"results\": [\"show\"]}'),
(607, 12, 25, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(608, 12, 6, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(609, 12, 52, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(610, 12, 38, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(611, 12, 40, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(612, 12, 7, '{\"results\": [\"show\"]}'),
(613, 12, 9, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(614, 12, 10, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"update_password\"]}'),
(615, 12, 8, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(616, 12, 1, '{\"results\": [\"show\"]}'),
(617, 12, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(618, 12, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(619, 12, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(620, 12, 15, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(621, 12, 16, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(622, 12, 17, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(623, 12, 13, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(624, 12, 12, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(625, 12, 49, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"review\"]}'),
(626, 12, 50, '{\"results\": [\"show\",\"add\",\"print\"]}'),
(627, 12, 19, '{\"results\": [\"show\"]}'),
(628, 12, 35, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(629, 12, 32, '{\"results\": [\"show\"]}'),
(630, 12, 20, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(631, 12, 21, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(632, 12, 28, '{\"results\": [\"show\",\"export\"]}'),
(633, 12, 26, '{\"results\": [\"show\",\"export\",\"closed\"]}'),
(634, 12, 27, '{\"results\": [\"show\",\"closed\"]}'),
(635, 12, 29, '{\"results\": [\"show\"]}'),
(636, 12, 36, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(637, 12, 31, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(638, 12, 30, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(639, 12, 33, '{\"results\": [\"show\"]}'),
(640, 12, 34, '{\"results\": [\"show\"]}'),
(641, 12, 37, '{\"results\": [\"show\",\"add\"]}'),
(642, 12, 41, '{\"results\": [\"show\"]}'),
(643, 12, 43, '{\"results\": [\"show\"]}'),
(644, 12, 39, '{\"results\": [\"show\"]}'),
(645, 12, 46, '{\"results\": [\"show\"]}'),
(646, 12, 42, '{\"results\": [\"show\"]}'),
(647, 12, 55, '{\"results\": [\"show\"]}'),
(648, 12, 54, '{\"results\": [\"show\"]}'),
(649, 12, 56, '{\"results\": [\"show\"]}'),
(650, 12, 44, '{\"results\": [\"show\"]}'),
(651, 12, 53, '{\"results\": [\"show\"]}'),
(652, 12, 45, '{\"results\": [\"show\"]}'),
(653, 12, 47, '{\"results\": [\"show\"]}'),
(654, 12, 48, '{\"results\": [\"show\"]}'),
(655, 12, 57, '{\"results\": [\"show\"]}'),
(656, 12, 51, '{\"results\": [\"show\"]}'),
(657, 12, 58, '{\"results\": [\"show\"]}'),
(658, 12, 59, '{\"results\": [\"show\"]}'),
(659, 12, 60, '{\"results\": [\"show\",\"export\"]}'),
(660, 12, 61, '{\"results\": [\"show\",\"export\"]}'),
(661, 12, 62, '{\"results\": [\"show\",\"export\"]}'),
(662, 12, 63, '{\"results\": [\"show\",\"export\"]}'),
(663, 12, 64, '{\"results\": [\"show\",\"export\"]}'),
(4262, 18, 24, '{\"results\": [\"show\"]}'),
(4263, 18, 52, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4264, 18, 7, '{\"results\": [\"show\"]}'),
(4265, 18, 9, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4266, 18, 10, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\",\"update_password\"]}'),
(4267, 18, 1, '{\"results\": [\"show\"]}'),
(4268, 18, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(4269, 18, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4270, 18, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4271, 18, 15, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4272, 18, 16, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4273, 18, 17, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4274, 18, 13, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4275, 18, 12, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4276, 18, 49, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"review\"]}'),
(4277, 18, 50, '{\"results\": [\"show\",\"add\",\"print\"]}'),
(4278, 18, 66, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4279, 18, 33, '{\"results\": [\"show\"]}'),
(4280, 18, 65, '{\"results\": [\"show\",\"export\"]}'),
(4281, 18, 55, '{\"results\": [\"show\"]}'),
(4282, 18, 54, '{\"results\": [\"show\",\"add\",\"export\",\"cancel\",\"receive\"]}'),
(4283, 18, 56, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4284, 18, 44, '{\"results\": [\"show\"]}'),
(4285, 18, 53, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4286, 18, 45, '{\"results\": [\"show\"]}'),
(4287, 18, 47, '{\"results\": [\"show\"]}'),
(4288, 18, 48, '{\"results\": [\"show\",\"export\"]}'),
(4289, 18, 57, '{\"results\": [\"show\",\"export\"]}'),
(4290, 18, 51, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(4291, 18, 58, '{\"results\": [\"show\",\"export\"]}'),
(4292, 18, 59, '{\"results\": [\"show\",\"export\"]}'),
(4293, 18, 60, '{\"results\": [\"show\",\"export\"]}'),
(4294, 18, 61, '{\"results\": [\"show\",\"export\"]}'),
(4295, 18, 62, '{\"results\": [\"show\",\"export\"]}'),
(4296, 18, 63, '{\"results\": [\"show\",\"export\"]}'),
(4297, 18, 64, '{\"results\": [\"show\",\"export\"]}'),
(4298, 18, 67, '{\"results\": [\"show\"]}'),
(4299, 18, 72, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(4300, 18, 68, '{\"results\": [\"show\",\"export\",\"cancel\",\"process\"]}'),
(4301, 18, 69, '{\"results\": [\"show\",\"update\",\"export\",\"cancel\",\"complete\"]}'),
(4302, 18, 70, '{\"results\": [\"show\",\"export\"]}'),
(4303, 18, 71, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(4450, 19, 24, '{\"results\": [\"show\"]}'),
(4451, 19, 25, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4452, 19, 6, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4453, 19, 52, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4454, 19, 38, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4455, 19, 40, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(4456, 19, 7, '{\"results\": [\"show\"]}'),
(4457, 19, 9, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4458, 19, 10, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\",\"update_password\"]}'),
(4459, 19, 8, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4460, 19, 1, '{\"results\": [\"show\"]}'),
(4461, 19, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(4462, 19, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4463, 19, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4464, 19, 15, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4465, 19, 16, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4466, 19, 17, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4467, 19, 13, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4468, 19, 12, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4469, 19, 49, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"review\"]}'),
(4470, 19, 50, '{\"results\": [\"show\",\"add\",\"print\"]}'),
(4471, 19, 66, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4472, 19, 19, '{\"results\": [\"show\"]}'),
(4473, 19, 35, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(4474, 19, 32, '{\"results\": [\"show\",\"delete\"]}'),
(4475, 19, 20, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(4476, 19, 21, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4477, 19, 28, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4478, 19, 26, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(4479, 19, 27, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4480, 19, 29, '{\"results\": [\"show\"]}'),
(4481, 19, 36, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(4482, 19, 31, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(4483, 19, 30, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(4484, 19, 33, '{\"results\": [\"show\"]}'),
(4485, 19, 34, '{\"results\": [\"show\",\"export\"]}'),
(4486, 19, 65, '{\"results\": [\"show\",\"export\"]}'),
(4487, 19, 37, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4488, 19, 41, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4489, 19, 43, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4490, 19, 39, '{\"results\": [\"show\",\"export\"]}'),
(4491, 19, 46, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4492, 19, 42, '{\"results\": [\"show\",\"update\",\"export\"]}'),
(4493, 19, 55, '{\"results\": [\"show\"]}'),
(4494, 19, 54, '{\"results\": [\"show\",\"add\",\"export\",\"cancel\",\"receive\"]}'),
(4495, 19, 56, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4496, 19, 44, '{\"results\": [\"show\"]}'),
(4497, 19, 53, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4498, 19, 45, '{\"results\": [\"show\"]}'),
(4499, 19, 47, '{\"results\": [\"show\"]}'),
(4500, 19, 48, '{\"results\": [\"show\",\"export\"]}'),
(4501, 19, 57, '{\"results\": [\"show\",\"export\"]}'),
(4502, 19, 51, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(4503, 19, 58, '{\"results\": [\"show\",\"export\"]}'),
(4504, 19, 59, '{\"results\": [\"show\",\"export\"]}'),
(4505, 19, 60, '{\"results\": [\"show\",\"export\"]}'),
(4506, 19, 61, '{\"results\": [\"show\",\"export\"]}'),
(4507, 19, 62, '{\"results\": [\"show\",\"export\"]}'),
(4508, 19, 63, '{\"results\": [\"show\",\"export\"]}'),
(4509, 19, 64, '{\"results\": [\"show\",\"export\"]}'),
(4510, 19, 67, '{\"results\": [\"show\"]}'),
(4511, 19, 72, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(4512, 19, 68, '{\"results\": [\"show\",\"export\",\"cancel\",\"process\"]}'),
(4513, 19, 69, '{\"results\": [\"show\",\"update\",\"export\",\"cancel\",\"complete\"]}'),
(4514, 19, 70, '{\"results\": [\"show\",\"export\"]}'),
(4515, 19, 71, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(4516, 19, 73, '{\"results\": [\"show\"]}'),
(4517, 19, 74, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\",\"process\"]}'),
(4518, 19, 75, '{\"results\": [\"show\",\"delete\",\"export\",\"approve\",\"cancel\",\"print\"]}'),
(4519, 19, 76, '{\"results\": [\"show\",\"export\",\"print\",\"sent\"]}'),
(4520, 19, 77, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4521, 19, 78, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4522, 19, 79, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4523, 20, 24, '{\"results\": [\"show\"]}'),
(4524, 20, 25, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4525, 20, 6, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4526, 20, 52, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4527, 20, 38, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4528, 20, 40, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(4529, 20, 7, '{\"results\": [\"show\"]}'),
(4530, 20, 9, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4531, 20, 10, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\",\"update_password\"]}'),
(4532, 20, 8, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4533, 20, 1, '{\"results\": [\"show\"]}'),
(4534, 20, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(4535, 20, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4536, 20, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4537, 20, 15, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4538, 20, 16, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4539, 20, 17, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4540, 20, 13, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4541, 20, 12, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4542, 20, 49, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"review\"]}'),
(4543, 20, 50, '{\"results\": [\"show\",\"add\",\"print\"]}'),
(4544, 20, 66, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4545, 20, 19, '{\"results\": [\"show\"]}'),
(4546, 20, 35, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(4547, 20, 32, '{\"results\": [\"show\",\"delete\"]}'),
(4548, 20, 20, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(4549, 20, 21, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4550, 20, 28, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4551, 20, 26, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(4552, 20, 27, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4553, 20, 29, '{\"results\": [\"show\"]}'),
(4554, 20, 36, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(4555, 20, 31, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(4556, 20, 30, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(4557, 20, 33, '{\"results\": [\"show\"]}'),
(4558, 20, 34, '{\"results\": [\"show\",\"export\"]}'),
(4559, 20, 65, '{\"results\": [\"show\",\"export\"]}'),
(4560, 20, 37, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4561, 20, 41, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4562, 20, 43, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4563, 20, 39, '{\"results\": [\"show\",\"export\"]}'),
(4564, 20, 46, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4565, 20, 42, '{\"results\": [\"show\",\"update\",\"export\"]}'),
(4566, 20, 55, '{\"results\": [\"show\"]}'),
(4567, 20, 54, '{\"results\": [\"show\",\"add\",\"export\",\"cancel\",\"receive\"]}'),
(4568, 20, 56, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4569, 20, 44, '{\"results\": [\"show\"]}'),
(4570, 20, 53, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4571, 20, 45, '{\"results\": [\"show\"]}'),
(4572, 20, 47, '{\"results\": [\"show\"]}'),
(4573, 20, 48, '{\"results\": [\"show\",\"export\"]}'),
(4574, 20, 57, '{\"results\": [\"show\",\"export\"]}'),
(4575, 20, 51, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(4576, 20, 58, '{\"results\": [\"show\",\"export\"]}'),
(4577, 20, 59, '{\"results\": [\"show\",\"export\"]}'),
(4578, 20, 60, '{\"results\": [\"show\",\"export\"]}'),
(4579, 20, 61, '{\"results\": [\"show\",\"export\"]}'),
(4580, 20, 62, '{\"results\": [\"show\",\"export\"]}'),
(4581, 20, 63, '{\"results\": [\"show\",\"export\"]}'),
(4582, 20, 64, '{\"results\": [\"show\",\"export\"]}'),
(4583, 20, 67, '{\"results\": [\"show\"]}'),
(4584, 20, 72, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(4585, 20, 68, '{\"results\": [\"show\",\"export\",\"cancel\",\"process\"]}'),
(4586, 20, 69, '{\"results\": [\"show\",\"update\",\"export\",\"cancel\",\"complete\"]}'),
(4587, 20, 70, '{\"results\": [\"show\",\"export\"]}'),
(4588, 20, 71, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(4589, 20, 73, '{\"results\": [\"show\"]}'),
(4590, 20, 74, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\",\"process\"]}'),
(4591, 20, 75, '{\"results\": [\"show\",\"delete\",\"export\",\"approve\",\"cancel\",\"print\"]}'),
(4592, 20, 76, '{\"results\": [\"show\",\"export\",\"print\",\"sent\"]}'),
(4593, 20, 77, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4594, 20, 78, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4595, 20, 79, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(4638, 21, 24, '{\"results\": [\"show\"]}'),
(4639, 21, 52, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4640, 21, 7, '{\"results\": [\"show\"]}'),
(4641, 21, 9, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4642, 21, 10, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\",\"update_password\"]}'),
(4643, 21, 1, '{\"results\": [\"show\"]}'),
(4644, 21, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(4645, 21, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4646, 21, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4647, 21, 15, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4648, 21, 16, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4649, 21, 17, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(4650, 21, 13, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4651, 21, 12, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4652, 21, 49, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"review\"]}'),
(4653, 21, 50, '{\"results\": [\"show\",\"add\",\"print\"]}'),
(4654, 21, 66, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4655, 21, 33, '{\"results\": [\"show\"]}'),
(4656, 21, 65, '{\"results\": [\"show\",\"export\"]}'),
(4657, 21, 55, '{\"results\": [\"show\"]}'),
(4658, 21, 54, '{\"results\": [\"show\",\"add\",\"export\",\"cancel\",\"receive\"]}'),
(4659, 21, 56, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(4660, 21, 44, '{\"results\": [\"show\"]}'),
(4661, 21, 53, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(4662, 21, 45, '{\"results\": [\"show\"]}'),
(4663, 21, 47, '{\"results\": [\"show\"]}'),
(4664, 21, 48, '{\"results\": [\"show\",\"export\"]}'),
(4665, 21, 57, '{\"results\": [\"show\",\"export\"]}'),
(4666, 21, 51, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(4667, 21, 58, '{\"results\": [\"show\",\"export\"]}'),
(4668, 21, 59, '{\"results\": [\"show\",\"export\"]}'),
(4669, 21, 60, '{\"results\": [\"show\",\"export\"]}'),
(4670, 21, 61, '{\"results\": [\"show\",\"export\"]}'),
(4671, 21, 62, '{\"results\": [\"show\",\"export\"]}'),
(4672, 21, 63, '{\"results\": [\"show\",\"export\"]}'),
(4673, 21, 64, '{\"results\": [\"show\",\"export\"]}'),
(4674, 21, 67, '{\"results\": [\"show\"]}'),
(4675, 21, 72, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(4676, 21, 68, '{\"results\": [\"show\",\"export\",\"cancel\",\"process\"]}'),
(4677, 21, 69, '{\"results\": [\"show\",\"update\",\"export\",\"cancel\",\"complete\"]}'),
(4678, 21, 70, '{\"results\": [\"show\",\"export\"]}'),
(4679, 21, 71, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(5412, 23, 24, '{\"results\": [\"show\"]}'),
(5413, 23, 98, '{\"results\": [\"show\"]}'),
(5414, 23, 44, '{\"results\": [\"show\"]}'),
(5415, 23, 53, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(5416, 23, 99, '{\"results\": [\"show\"]}'),
(5417, 23, 47, '{\"results\": [\"show\"]}'),
(5418, 23, 101, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(5419, 26, 1, '{\"results\": [\"show\"]}'),
(5420, 26, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(5421, 26, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(5422, 26, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(5423, 26, 44, '{\"results\": [\"show\"]}'),
(5424, 26, 100, '{\"results\": [\"show\"]}'),
(5425, 26, 47, '{\"results\": [\"show\"]}'),
(5426, 26, 48, '{\"results\": [\"show\",\"export\"]}'),
(5427, 26, 57, '{\"results\": [\"show\",\"export\"]}'),
(5428, 26, 58, '{\"results\": [\"show\",\"export\"]}'),
(5429, 26, 59, '{\"results\": [\"show\",\"export\"]}'),
(5430, 26, 60, '{\"results\": [\"show\",\"export\"]}'),
(5431, 26, 61, '{\"results\": [\"show\",\"export\"]}'),
(5432, 26, 62, '{\"results\": [\"show\",\"export\"]}'),
(5433, 26, 63, '{\"results\": [\"show\",\"export\"]}'),
(5434, 26, 64, '{\"results\": [\"show\",\"export\"]}'),
(5435, 26, 95, '{\"results\": [\"show\",\"export\"]}'),
(5436, 26, 96, '{\"results\": [\"show\",\"export\"]}'),
(5437, 26, 97, '{\"results\": [\"show\",\"export\"]}'),
(5438, 27, 1, '{\"results\": [\"show\"]}'),
(5439, 27, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(5440, 27, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(5441, 27, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(5442, 27, 44, '{\"results\": [\"show\"]}'),
(5443, 27, 100, '{\"results\": [\"show\"]}'),
(5444, 27, 47, '{\"results\": [\"show\"]}'),
(5445, 27, 48, '{\"results\": [\"show\",\"export\"]}'),
(5446, 27, 57, '{\"results\": [\"show\",\"export\"]}'),
(5447, 27, 58, '{\"results\": [\"show\",\"export\"]}'),
(5448, 27, 59, '{\"results\": [\"show\",\"export\"]}'),
(5449, 27, 60, '{\"results\": [\"show\",\"export\"]}'),
(5450, 27, 61, '{\"results\": [\"show\",\"export\"]}'),
(5451, 27, 62, '{\"results\": [\"show\",\"export\"]}'),
(5452, 27, 63, '{\"results\": [\"show\",\"export\"]}'),
(5453, 27, 64, '{\"results\": [\"show\",\"export\"]}'),
(5454, 27, 95, '{\"results\": [\"show\",\"export\"]}'),
(5455, 27, 96, '{\"results\": [\"show\",\"export\"]}'),
(5456, 27, 97, '{\"results\": [\"show\",\"export\"]}'),
(6544, 3, 24, '{\"results\": [\"show\"]}'),
(6545, 3, 25, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6546, 3, 6, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6547, 3, 52, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6548, 3, 98, '{\"results\": [\"show\"]}'),
(6549, 3, 38, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6550, 3, 40, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(6551, 3, 81, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6552, 3, 102, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6553, 3, 7, '{\"results\": [\"show\"]}'),
(6554, 3, 9, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(6555, 3, 10, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\",\"update_password\"]}'),
(6556, 3, 8, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(6557, 3, 1, '{\"results\": [\"show\"]}'),
(6558, 3, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(6559, 3, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6560, 3, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6561, 3, 15, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6562, 3, 16, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6563, 3, 17, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(6564, 3, 13, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6565, 3, 12, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6566, 3, 49, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"review\"]}'),
(6567, 3, 50, '{\"results\": [\"show\",\"add\",\"print\"]}'),
(6568, 3, 66, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6569, 3, 80, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6570, 3, 105, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6571, 3, 19, '{\"results\": [\"show\"]}'),
(6572, 3, 35, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(6573, 3, 32, '{\"results\": [\"show\",\"delete\"]}'),
(6574, 3, 20, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(6575, 3, 21, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6576, 3, 28, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6577, 3, 26, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(6578, 3, 27, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6579, 3, 90, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"print\"]}'),
(6580, 3, 29, '{\"results\": [\"show\"]}'),
(6581, 3, 36, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(6582, 3, 31, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(6583, 3, 30, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(6584, 3, 33, '{\"results\": [\"show\"]}'),
(6585, 3, 34, '{\"results\": [\"show\",\"export\"]}'),
(6586, 3, 65, '{\"results\": [\"show\",\"export\"]}'),
(6587, 3, 37, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6588, 3, 41, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6589, 3, 43, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6590, 3, 39, '{\"results\": [\"show\",\"export\"]}'),
(6591, 3, 46, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6592, 3, 42, '{\"results\": [\"show\",\"update\",\"export\"]}'),
(6593, 3, 55, '{\"results\": [\"show\"]}'),
(6594, 3, 54, '{\"results\": [\"show\",\"add\",\"export\",\"cancel\",\"receive\"]}'),
(6595, 3, 56, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6596, 3, 44, '{\"results\": [\"show\"]}'),
(6597, 3, 53, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6598, 3, 45, '{\"results\": [\"show\"]}'),
(6599, 3, 99, '{\"results\": [\"show\"]}'),
(6600, 3, 100, '{\"results\": [\"show\"]}'),
(6601, 3, 89, '{\"results\": [\"show\",\"add\",\"export\",\"upload\"]}'),
(6602, 3, 47, '{\"results\": [\"show\"]}'),
(6603, 3, 48, '{\"results\": [\"show\",\"export\"]}'),
(6604, 3, 57, '{\"results\": [\"show\",\"export\"]}'),
(6605, 3, 51, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(6606, 3, 101, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(6607, 3, 58, '{\"results\": [\"show\",\"export\"]}'),
(6608, 3, 59, '{\"results\": [\"show\",\"export\"]}'),
(6609, 3, 60, '{\"results\": [\"show\",\"export\"]}'),
(6610, 3, 61, '{\"results\": [\"show\",\"export\"]}'),
(6611, 3, 62, '{\"results\": [\"show\",\"export\"]}'),
(6612, 3, 63, '{\"results\": [\"show\",\"export\"]}'),
(6613, 3, 64, '{\"results\": [\"show\",\"export\"]}'),
(6614, 3, 95, '{\"results\": [\"show\",\"export\"]}'),
(6615, 3, 96, '{\"results\": [\"show\",\"export\"]}'),
(6616, 3, 97, '{\"results\": [\"show\",\"export\"]}'),
(6617, 3, 104, '{\"results\": [\"show\",\"export\"]}'),
(6618, 3, 106, '{\"results\": [\"show\",\"export\"]}'),
(6619, 3, 107, '{\"results\": [\"show\",\"export\"]}'),
(6620, 3, 110, '{\"results\": [\"show\",\"export\"]}'),
(6621, 3, 67, '{\"results\": [\"show\"]}'),
(6622, 3, 72, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(6623, 3, 68, '{\"results\": [\"show\",\"export\",\"cancel\",\"process\"]}'),
(6624, 3, 69, '{\"results\": [\"show\",\"update\",\"export\",\"cancel\",\"complete\"]}'),
(6625, 3, 70, '{\"results\": [\"show\",\"export\"]}'),
(6626, 3, 71, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(6627, 3, 73, '{\"results\": [\"show\"]}'),
(6628, 3, 74, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\",\"process\"]}'),
(6629, 3, 75, '{\"results\": [\"show\",\"delete\",\"export\",\"approve\",\"cancel\",\"print\"]}'),
(6630, 3, 76, '{\"results\": [\"show\",\"export\",\"print\",\"sent\"]}'),
(6631, 3, 77, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6632, 3, 78, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6633, 3, 79, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6634, 3, 82, '{\"results\": [\"show\"]}'),
(6635, 3, 83, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"print\",\"process\"]}'),
(6636, 3, 84, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6637, 3, 85, '{\"results\": [\"show\",\"export\",\"print\",\"process\"]}'),
(6638, 3, 86, '{\"results\": [\"show\",\"export\",\"print\",\"complete\"]}'),
(6639, 3, 87, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6640, 3, 88, '{\"results\": [\"show\",\"receive\",\"print\"]}'),
(6641, 3, 91, '{\"results\": [\"show\"]}'),
(6642, 3, 92, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(6643, 3, 103, '{\"results\": [\"show\"]}'),
(6644, 3, 93, '{\"results\": [\"show\"]}'),
(6645, 3, 94, '{\"results\": [\"show\",\"export\"]}'),
(6646, 10, 24, '{\"results\": [\"show\"]}'),
(6647, 10, 25, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6648, 10, 6, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6649, 10, 52, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6650, 10, 98, '{\"results\": [\"show\"]}'),
(6651, 10, 38, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6652, 10, 40, '{\"results\": [\"show\",\"add\",\"update\",\"delete\"]}'),
(6653, 10, 81, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6654, 10, 102, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6655, 10, 7, '{\"results\": [\"show\"]}'),
(6656, 10, 9, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(6657, 10, 10, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\",\"update_password\"]}'),
(6658, 10, 8, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(6659, 10, 1, '{\"results\": [\"show\"]}'),
(6660, 10, 11, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"activate\",\"deactivate\"]}'),
(6661, 10, 14, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6662, 10, 23, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6663, 10, 15, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6664, 10, 16, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6665, 10, 17, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"activate\",\"deactivate\"]}'),
(6666, 10, 13, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6667, 10, 12, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6668, 10, 49, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"review\"]}'),
(6669, 10, 50, '{\"results\": [\"show\",\"add\",\"print\"]}'),
(6670, 10, 66, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6671, 10, 80, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6672, 10, 105, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6673, 10, 19, '{\"results\": [\"show\"]}'),
(6674, 10, 35, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(6675, 10, 32, '{\"results\": [\"show\",\"delete\"]}'),
(6676, 10, 20, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(6677, 10, 21, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6678, 10, 28, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6679, 10, 26, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(6680, 10, 27, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6681, 10, 90, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"print\"]}'),
(6682, 10, 29, '{\"results\": [\"show\"]}'),
(6683, 10, 36, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(6684, 10, 31, '{\"results\": [\"show\",\"add\",\"update\",\"export\",\"approve\",\"print\"]}'),
(6685, 10, 30, '{\"results\": [\"show\",\"export\",\"closed\",\"print\"]}'),
(6686, 10, 33, '{\"results\": [\"show\"]}'),
(6687, 10, 34, '{\"results\": [\"show\",\"export\"]}'),
(6688, 10, 65, '{\"results\": [\"show\",\"export\"]}'),
(6689, 10, 37, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6690, 10, 41, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6691, 10, 43, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6692, 10, 39, '{\"results\": [\"show\",\"export\"]}'),
(6693, 10, 46, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6694, 10, 42, '{\"results\": [\"show\",\"update\",\"export\"]}'),
(6695, 10, 55, '{\"results\": [\"show\"]}'),
(6696, 10, 54, '{\"results\": [\"show\",\"add\",\"export\",\"cancel\",\"receive\"]}'),
(6697, 10, 56, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6698, 10, 44, '{\"results\": [\"show\"]}'),
(6699, 10, 53, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\"]}'),
(6700, 10, 45, '{\"results\": [\"show\"]}'),
(6701, 10, 99, '{\"results\": [\"show\"]}'),
(6702, 10, 100, '{\"results\": [\"show\"]}'),
(6703, 10, 89, '{\"results\": [\"show\",\"add\",\"export\",\"upload\"]}'),
(6704, 10, 47, '{\"results\": [\"show\"]}'),
(6705, 10, 48, '{\"results\": [\"show\",\"export\"]}'),
(6706, 10, 57, '{\"results\": [\"show\",\"export\"]}'),
(6707, 10, 51, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(6708, 10, 101, '{\"results\": [\"show\",\"update\",\"export\",\"print\"]}'),
(6709, 10, 58, '{\"results\": [\"show\",\"export\"]}'),
(6710, 10, 59, '{\"results\": [\"show\",\"export\"]}'),
(6711, 10, 60, '{\"results\": [\"show\",\"export\"]}'),
(6712, 10, 61, '{\"results\": [\"show\",\"export\"]}'),
(6713, 10, 62, '{\"results\": [\"show\",\"export\"]}'),
(6714, 10, 63, '{\"results\": [\"show\",\"export\"]}'),
(6715, 10, 64, '{\"results\": [\"show\",\"export\"]}'),
(6716, 10, 95, '{\"results\": [\"show\",\"export\"]}'),
(6717, 10, 96, '{\"results\": [\"show\",\"export\"]}'),
(6718, 10, 97, '{\"results\": [\"show\",\"export\"]}'),
(6719, 10, 104, '{\"results\": [\"show\",\"export\"]}'),
(6720, 10, 106, '{\"results\": [\"show\",\"export\"]}'),
(6721, 10, 107, '{\"results\": [\"show\",\"export\"]}'),
(6722, 10, 110, '{\"results\": [\"show\",\"export\"]}'),
(6723, 10, 67, '{\"results\": [\"show\"]}'),
(6724, 10, 72, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(6725, 10, 68, '{\"results\": [\"show\",\"export\",\"cancel\",\"process\"]}'),
(6726, 10, 69, '{\"results\": [\"show\",\"update\",\"export\",\"cancel\",\"complete\"]}'),
(6727, 10, 70, '{\"results\": [\"show\",\"export\"]}'),
(6728, 10, 71, '{\"results\": [\"show\",\"add\",\"delete\",\"export\"]}'),
(6729, 10, 73, '{\"results\": [\"show\"]}'),
(6730, 10, 74, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\",\"process\"]}'),
(6731, 10, 75, '{\"results\": [\"show\",\"delete\",\"export\",\"approve\",\"cancel\",\"print\"]}'),
(6732, 10, 76, '{\"results\": [\"show\",\"export\",\"print\",\"sent\"]}'),
(6733, 10, 77, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6734, 10, 78, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6735, 10, 79, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6736, 10, 82, '{\"results\": [\"show\"]}'),
(6737, 10, 83, '{\"results\": [\"show\",\"add\",\"delete\",\"export\",\"print\",\"process\"]}'),
(6738, 10, 84, '{\"results\": [\"show\",\"export\",\"approve\",\"reject\",\"print\"]}'),
(6739, 10, 85, '{\"results\": [\"show\",\"export\",\"print\",\"process\"]}'),
(6740, 10, 86, '{\"results\": [\"show\",\"export\",\"print\",\"complete\"]}'),
(6741, 10, 87, '{\"results\": [\"show\",\"export\",\"print\"]}'),
(6742, 10, 88, '{\"results\": [\"show\",\"receive\",\"print\"]}'),
(6743, 10, 91, '{\"results\": [\"show\"]}'),
(6744, 10, 92, '{\"results\": [\"show\",\"add\",\"update\",\"delete\",\"export\",\"print\"]}'),
(6745, 10, 103, '{\"results\": [\"show\"]}'),
(6746, 10, 93, '{\"results\": [\"show\"]}'),
(6747, 10, 94, '{\"results\": [\"show\",\"export\"]}');

-- --------------------------------------------------------

--
-- Struktur dari tabel `sys_administrator_warehouse`
--

CREATE TABLE `sys_administrator_warehouse` (
  `administrator_warehouse_id` int(10) UNSIGNED NOT NULL,
  `administrator_warehouse_administrator_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'ID administrator',
  `administrator_warehouse_warehouse_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'ID warehouse'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table administrator di warehouse';

--
-- Dumping data untuk tabel `sys_administrator_warehouse`
--

INSERT INTO `sys_administrator_warehouse` (`administrator_warehouse_id`, `administrator_warehouse_administrator_id`, `administrator_warehouse_warehouse_id`) VALUES
(1, 2, 1),
(2, 3, 3),
(3, 4, 4),
(5, 6, 2),
...
--
-- Struktur dari tabel `sys_company`
--

CREATE TABLE `sys_company` (
  `company_id` int(10) UNSIGNED NOT NULL COMMENT 'ID perusahaan',
  `company_title` varchar(50) NOT NULL COMMENT 'Nama perusahaan',
  `company_address` varchar(50) DEFAULT NULL COMMENT 'alamat perusahaan',
  `company_province_name` varchar(50) DEFAULT NULL COMMENT 'Nama provinsi',
  `company_city_name` varchar(50) DEFAULT NULL COMMENT 'Nama kota',
  `company_subdistrict_name` varchar(50) DEFAULT NULL COMMENT 'Nama kecamatan',
  `company_zip_code` varchar(10) DEFAULT NULL COMMENT 'kodepos',
  `company_phone_fax` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'phone dan fax' CHECK (json_valid(`company_phone_fax`)),
  `company_contact_person` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'contact person' CHECK (json_valid(`company_contact_person`)),
  `company_image` varchar(255) DEFAULT NULL COMMENT 'logo perusahaan'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table perusahaan';

--
-- Dumping data untuk tabel `sys_company`
--

INSERT INTO `sys_company` (`company_id`, `company_title`, `company_address`, `company_province_name`, `company_city_name`, `company_subdistrict_name`, `company_zip_code`, `company_phone_fax`, `company_contact_person`, `company_image`) VALUES
(1, 'coba aja', 'coba aja lagi', 'Sumatera Utara', 'KAB. TAPANULI UTARA', 'Tarutung', '', '{\"results\": [{\"fax\": \"gfdrtfghyfdre\", \"phone\": \"021234567780978\", \"mobile_phone\": \"\"}]}', '{\"results\": []}', NULL),
(2, 'PT Sejahtera', 'JL Asri ', 'Riau', 'KAB. INDRAGIRI HILIR', 'Kuala Indragiri', '', '{\"results\": []}', '{\"results\": []}', NULL),
(3, 'PT Netindo Solution Group', 'Yogyakarta', 'Di Yogyakarta', 'KAB. SLEMAN', 'Sleman', '', '{\"results\": [{\"fax\": \"946738945735\", \"phone\": \"\", \"mobile_phone\": \"081236586445\"}]}', '{\"results\": [{\"name\": \"Mr. W\", \"phone\": \"0812345676546\", \"address\": \"Jalan Wiyoro Lor\"}]}', 'PT-Netindo-Solution-Group-20190311114857.jpg'),
(4, 'PT Apa saja', 'jogja', 'Di Yogyakarta', 'KAB. SLEMAN', 'Berbah', '', '{\"results\": [{\"fax\": \"01212\", \"phone\": \"121212\", \"mobile_phone\": \"9097986872\"}, {\"fax\": \"12162172\", \"phone\": \"5646212\", \"mobile_phone\": \"08798798909\"}]}', '{\"results\": [{\"name\": \"ajeng\", \"phone\": \"0879879688768\", \"address\": \"jogja\"}, {\"name\": \"setyo\", \"phone\": \"897987987999\", \"address\": \"jogja\"}]}', 'PT-Apa-saja-20190311114557.png'),
(6, 'Siap Cetak Inspiration', 'Jalan Ring Road Timur No. 59', 'Di Yogyakarta', 'KAB. BANTUL', 'Banguntapan', '', '{\"results\": [{\"fax\": \"495648235\", \"phone\": \"02132325456\", \"mobile_phone\": \"0848354593473\"}]}', '{\"results\": [{\"name\": \"Bp Slamet\", \"phone\": \"\", \"address\": \"\"}]}', 'Siap-Cetak-Inspiration-20190311114811.jpg'),
(7, 'PT Maju mundur', 'Jogja', 'Aceh', 'KAB. ACEH TENGGARA', 'Lawe Alas', '', '{\"results\": []}', '{\"results\": []}', 'PT-Maju-mundur-20190311114537.png'),
(8, 'PT Sejahtera', 'Wirobrajan', 'Aceh', 'KAB. ACEH SELATAN', 'Bakongan', '', '{\"results\": []}', '{\"results\": []}', 'PT-Sejahtera-20190311113011.jpg'),
(10, 'PT Joyo', 'Jl. Melati', 'Jawa Tengah', 'KAB. BANYUMAS', 'Jatilawang', '', '{\"results\": [{\"fax\": \"\", \"phone\": \"0812345678890\", \"mobile_phone\": \"\"}]}', '{\"results\": []}', NULL),
(11, 'PT Coba a', 'Wonosarii', 'Di Yogyakarta', 'KAB. GUNUNG KIDUL', 'Wonosari', '55555', '{\"results\": [{\"fax\": \"242352451\", \"phone\": \"2342545\", \"mobile_phone\": \"2352452343243\"}]}', '{\"results\": [{\"name\": \"dors\", \"phone\": \"78238648722\", \"address\": \"wonosari 451\"}]}', 'PT-Coba-a-20190618114937.png'),
(12, 'UMKM NUSANTARA', 'Yogyakarta', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(13, 'Merchant 1', 'yogyakarta', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(14, 'Merchant 2', 'Yogyakarta', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `sys_officer`
--
...
CREATE TABLE `sys_officer` (
  ...
  `gajih_karyawan` int(12) NOT NULL,
  `foto_karyawan` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `sys_officer`
--

INSERT INTO `sys_officer` (`karyawan_id`, `nama_karyawan`, `alamat_karyawan`, `gajih_karyawan`, `foto_karyawan`) VALUES
(14, 'fadhillah', 'jl.peta nomor 62', 10000, 'fadhillah-20191230112200.png'),
(15, 'Aswar', 'jl.anu nomor 88', 5000000, '');

-- --------------------------------------------------------

--
-- Struktur dari tabel `sys_pos`
--

CREATE TABLE `sys_pos` (
  `pos_id` int(10) UNSIGNED NOT NULL COMMENT 'ID POS',
  `pos_company_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'ID perusahaan',
  `pos_code` varchar(15) NOT NULL COMMENT 'Kode POS',
  `pos_name` varchar(50) NOT NULL COMMENT 'Nama POS',
  `pos_address` varchar(50) NOT NULL COMMENT 'Alamat POS',
  `pos_province_name` varchar(50) DEFAULT NULL COMMENT 'Nama provinsi',
  `pos_city_name` varchar(50) DEFAULT NULL COMMENT 'Nama kota',
  `pos_subdistrict_name` varchar(50) DEFAULT NULL COMMENT 'Nama kecamatan',
  `pos_zip_code` varchar(10) DEFAULT NULL COMMENT 'Kodepos',
  `pos_phone_fax` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Phone dan fax',
  `pos_contact_person` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Contact person',
  `pos_pos_config_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Config POS per outlet. contoh:  {"pos_type":"resto/retail","struck_template":{"header":{"logo_filename":"","title_text_1":"","title_text_2":"","title_text_3":""},"footer":{"text_1":""},"paper_size":""}}' CHECK (json_valid(`pos_pos_config_json`))
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table pos';

--
-- Dumping data untuk tabel `sys_pos`
--

INSERT INTO `sys_pos` (`pos_id`, `pos_company_id`, `pos_code`, `pos_name`, `pos_address`, `pos_province_name`, `pos_city_name`, `pos_subdistrict_name`, `pos_zip_code`, `pos_phone_fax`, `pos_contact_person`, `pos_pos_config_json`) VALUES
(1, 3, '00002', 'cobaa', 'aa', 'Aceh', 'KAB. ACEH SELATAN', 'Bakongan', '', '{\"results\": [{\"fax\":\"11111\",\"phone\":\"11111111\",\"mobile_phone\":\"1111111111111\"}]}', '{\"results\": []}', NULL),
(2, 2, '00003', 'coba', 'aa', 'Aceh', 'KAB. ACEH SELATAN', 'Kluet Selatan', '', '{\"results\": []}', '{\"results\": []}', NULL),
(3, 3, '00004', 'cobaa', 'aa', 'Aceh', 'KAB. ACEH SELATAN', 'Bakongan', '', '{\"results\": [{\"fax\":\"11111\",\"phone\":\"11111111\",\"mobile_phone\":\"1111111111111\"}]}', '{\"results\": []}', NULL),
(4, 4, '00005', 'Store PT apa saja', 'jogja', 'Di Yogyakarta', 'KAB. SLEMAN', 'Berbah', '', '{\"results\": []}', '{\"results\": []}', NULL),
(5, 4, '00006', 'Store PT apa saja', 'jogja', 'Di Yogyakarta', 'KAB. SLEMAN', 'Berbah', '', '{\"results\": []}', '{\"results\": []}', NULL),
(7, 4, '00008', 'tes', 'a', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(8, 5, '00009', 'tes', 'a', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(9, 6, '00010', 'SCI Store', 'Jalan Ring Road Timur No. 59', 'Di Yogyakarta', 'KAB. BANTUL', 'Banguntapan', '', '{\"results\": [{\"fax\":\"\",\"phone\":\"0986136355764\",\"mobile_phone\":\"\"}]}', '{\"results\": []}', NULL),
(10, 3, '00011', 'Coday Resto Jurugentong', 'Jurugentong', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(11, 3, '00012', 'coba stock store', 'a', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(12, 11, '00013', 'aww', 'wonosari', 'Sumatera Selatan', 'KAB. MUSI RAWAS', 'Muara Beliti', '111111', '{\"results\": [{\"fax\":\"11111111\",\"phone\":\"111112111\",\"mobile_phone\":\"1111111111111\"}]}', '{\"results\": [{\"name\":\"waa\",\"address\":\"wonosari\",\"phone\":\"1111111211111\"}]}', NULL),
(13, 12, '00014', 'UMKM STORE', 'Yogyakarta', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(14, 13, '00015', 'MERCHANT 1', 'Yogyakarta', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(15, 14, '00016', 'MERCHANT 2', 'Yogyakarta', '', '', '', '', '{\"results\": []}', '{\"results\": []}', '{\"pos_type\": \"resto\", \"struck_template\": {\"footer\": {\"text_1\": \"ddd\"}, \"header\": {\"title_text_1\": \"aaaaa\", \"title_text_2\": \"bbbb\", \"title_text_3\": \"cc\", \"logo_filename\": \"MERCHANT-2-20190826164818.png\"}, \"paper_size\": \"mini\"}}');

-- --------------------------------------------------------

--
-- Struktur dari tabel `sys_warehouse`
--

CREATE TABLE `sys_warehouse` (
  `warehouse_id` int(10) UNSIGNED NOT NULL COMMENT 'ID warehouse',
  `warehouse_company_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'ID perusahaan',
  `warehouse_code` varchar(15) NOT NULL COMMENT 'Kode warehouse',
  `warehouse_name` varchar(50) NOT NULL COMMENT 'Nama warehouse',
  `warehouse_address` varchar(50) NOT NULL COMMENT 'Alamat warehouse',
  `warehouse_province_name` varchar(50) DEFAULT NULL COMMENT 'Nama provinsi',
  `warehouse_city_name` varchar(50) DEFAULT NULL COMMENT 'Nama kota',
  `warehouse_subdistrict_name` varchar(50) DEFAULT NULL COMMENT 'Nama kecamatan',
  `warehouse_zip_code` varchar(10) DEFAULT NULL COMMENT 'Kodepos',
  `warehouse_phone_fax` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Phone dan fax' CHECK (json_valid(`warehouse_phone_fax`)),
  `warehouse_contact_person` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Contact person' CHECK (json_valid(`warehouse_contact_person`)),
  `warehouse_pos_config_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Config POS per outlet. contoh:  {"pos_type":"resto/retail","struck_template":{"header":{"logo_filename":"","title_text_1":"","title_text_2":"","title_text_3":""},"footer":{"text_1":""},"paper_size":""}}' CHECK (json_valid(`warehouse_pos_config_json`))
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table warehouse';

--
-- Dumping data untuk tabel `sys_warehouse`
--

INSERT INTO `sys_warehouse` (`warehouse_id`, `warehouse_company_id`, `warehouse_code`, `warehouse_name`, `warehouse_address`, `warehouse_province_name`, `warehouse_city_name`, `warehouse_subdistrict_name`, `warehouse_zip_code`, `warehouse_phone_fax`, `warehouse_contact_person`, `warehouse_pos_config_json`) VALUES
(2, 2, '00001', 'Sejahtera WH', 'JL maju muju', 'Riau', 'KAB. INDRAGIRI HULU', 'Rengat Barat', '', '{\"results\": []}', '{\"results\": []}', NULL),
(3, 3, '00001', 'Coday Skylight Resto', 'Yogyakarta', 'Di Yogyakarta', 'KAB. SLEMAN', 'Sleman', '', '{\"results\": [{\"fax\": \"03483652323\", \"phone\": \"021345463452\", \"mobile_phone\": \"0213243667980\"}]}', '{\"results\": [{\"name\": \"Mr. Habib\", \"phone\": \"\", \"address\": \"\"}]}', '{\"pos_type\": \"retail\", \"struck_template\": {\"footer\": {\"text_1\": \"*Harga Sudah Termasuk PPN\"}, \"header\": {\"title_text_1\": \"UMKM NUSANTARAA\", \"title_text_2\": \"Jl. Ahmad Wahid, Kalangan, Baturetno, Banguntapan, Bantul, Yogyakarta\", \"title_text_3\": \"0274-8000022\", \"logo_filename\": \"Coday-Skylight-Resto-20190918134159.png\"}, \"paper_size\": \"mini\"}}'),
(4, 4, '00001', 'Warehouse PT apa saja', 'jogja', 'Di Yogyakarta', 'KAB. SLEMAN', 'Berbah', '', '{\"results\": []}', '{\"results\": []}', NULL),
(5, 5, '00001', 'coba 1', 'jogja\r\n', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(6, 5, '00002', 'coba 2', 'jogja', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(7, 6, '00001', 'SCI WH', 'Jalan Ring Road Timur No. 59', 'Di Yogyakarta', 'KAB. BANTUL', 'Banguntapan', '', '{\"results\": []}', '{\"results\": []}', NULL),
(8, 7, '00001', 'Klontong', 'Wirobrajan', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(9, 3, '00002', 'Coday Jurugentong', 'Jurugentong', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(10, 3, '00003', 'test stock', 'a', '', '', '', '', '{\"results\": []}', '{\"results\": []}', NULL),
(11, 10, '00010', 'aa', 'aa', 'Aceh', 'KAB. ACEH SELATAN', 'Bakongan', '', '{\"results\": []}', '{\"results\": []}', NULL),
(12, 11, '00001', 'aeh', 'auh', 'Sumatera Utara', 'KAB. LANGKAT', 'Sei Bingei', '12142', '{\"results\": []}', '{\"results\": []}', '{\"pos_type\": \"resto\", \"struck_template\": {\"footer\": {\"text_1\": \"aaa\"}, \"header\": {\"title_text_1\": \"aa\", \"title_text_2\": \"aaa\", \"title_text_3\": \"aa\", \"logo_filename\": \"\"}, \"paper_size\": \"mini\"}}'),
(13, 3, '00004', 'coba config', 'aaa', '', '', '', '', '{\"results\": []}', '{\"results\": []}', '{\"pos_type\": \"resto\", \"struck_template\": {\"footer\": {\"text_1\": \"ddd\"}, \"header\": {\"title_text_1\": \"aaaa\", \"title_text_2\": \"bbbbb\", \"title_text_3\": \"ccc\", \"logo_filename\": \"\"}, \"paper_size\": \"mini\"}}');
...
--
-- Indeks untuk tabel `ref_hacker`
--
ALTER TABLE `ref_hacker`
...
ALTER TABLE `ref_subdistrict`
  ...
  ADD KEY `subdistrict_city_id` (`subdistrict_city_id`);

--
-- Indeks untuk tabel `site_configuration`
--
ALTER TABLE `site_configuration`
  ADD PRIMARY KEY (`configuration_id`);

--
-- Indeks untuk tabel `sys_administrator`
--
ALTER TABLE `sys_administrator`
  ADD PRIMARY KEY (`administrator_id`),
  ADD KEY `administrator_administrator_group_id` (`administrator_administrator_group_id`);

--
-- Indeks untuk tabel `sys_administrator_group`
--
ALTER TABLE `sys_administrator_group`
  ADD PRIMARY KEY (`administrator_group_id`),
  ADD KEY `administrator_group_company_id` (`administrator_group_company_id`),
  ADD KEY `administrator_group_warehouse_id` (`administrator_group_warehouse_id`);

--
-- Indeks untuk tabel `sys_administrator_menu`
--
ALTER TABLE `sys_administrator_menu`
  ADD PRIMARY KEY (`administrator_menu_id`),
  ADD KEY `administrator_menu_par_id` (`administrator_menu_par_id`);

--
-- Indeks untuk tabel `sys_administrator_menu_ref_action`
--
ALTER TABLE `sys_administrator_menu_ref_action`
  ADD PRIMARY KEY (`administrator_menu_ref_action_id`);

--
-- Indeks untuk tabel `sys_administrator_privilege`
--
ALTER TABLE `sys_administrator_privilege`
  ADD PRIMARY KEY (`administrator_privilege_id`),
  ADD KEY `administrator_privilege_administrator_group_id` (`administrator_privilege_administrator_group_id`),
  ADD KEY `administrator_privilege_administrator_menu_id` (`administrator_privilege_administrator_menu_id`);

--
-- Indeks untuk tabel `sys_administrator_warehouse`
--
ALTER TABLE `sys_administrator_warehouse`
  ADD PRIMARY KEY (`administrator_warehouse_id`),
  ADD KEY `administrator_warehouse_administrator_id` (`administrator_warehouse_administrator_id`),
  ADD KEY `administrator_warehouse_warehouse_id` (`administrator_warehouse_warehouse_id`);

--
-- Indeks untuk tabel `sys_company`
--
ALTER TABLE `sys_company`
  ADD PRIMARY KEY (`company_id`);

--
-- Indeks untuk tabel `sys_officer`
--
ALTER TABLE `sys_officer`
  ADD PRIMARY KEY (`karyawan_id`);

--
-- Indeks untuk tabel `sys_pos`
--
ALTER TABLE `sys_pos`
  ADD PRIMARY KEY (`pos_id`);

--
-- Indeks untuk tabel `sys_warehouse`
--
...
--
-- AUTO_INCREMENT untuk tabel `site_configuration`
--
ALTER TABLE `site_configuration`
  MODIFY `configuration_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT untuk tabel `sys_administrator`
--
ALTER TABLE `sys_administrator`
  MODIFY `administrator_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `sys_administrator_group`
--
ALTER TABLE `sys_administrator_group`
  MODIFY `administrator_group_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT untuk tabel `sys_administrator_menu`
--
ALTER TABLE `sys_administrator_menu`
  MODIFY `administrator_menu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

--
-- AUTO_INCREMENT untuk tabel `sys_administrator_menu_ref_action`
--
ALTER TABLE `sys_administrator_menu_ref_action`
  MODIFY `administrator_menu_ref_action_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT untuk tabel `sys_administrator_privilege`
--
ALTER TABLE `sys_administrator_privilege`
  MODIFY `administrator_privilege_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6748;

--
-- AUTO_INCREMENT untuk tabel `sys_administrator_warehouse`
--
ALTER TABLE `sys_administrator_warehouse`
  MODIFY `administrator_warehouse_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `sys_company`
--
ALTER TABLE `sys_company`
  MODIFY `company_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID perusahaan', AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `sys_officer`
--
ALTER TABLE `sys_officer`
  MODIFY `karyawan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `sys_pos`
--
ALTER TABLE `sys_pos`
  MODIFY `pos_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID POS', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `sys_warehouse`
--
ALTER TABLE `sys_warehouse`
  MODIFY `warehouse_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID warehouse', AUTO_INCREMENT=14;
COMMIT;
